...
- Added two new menu categories to the menu page and several new menu items.
- Updated side information on `menu.html` page.
- Updated infobar text content on `index.html` page.
